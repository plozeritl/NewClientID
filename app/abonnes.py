...
Convention de Stripe, vérifiée sur le compte le 11/09/2026 : un abonné actif est un
client avec au moins un abonnement au statut 'active' qui facture quelque chose.
Les impayés ('past_due') n'en font pas partie (3 701 affichés contre 4 061 en les
incluant). Un client avec deux abonnements compte pour un ; un client en essai
gratuit, qui ne paie encore rien, ne compte pas.
